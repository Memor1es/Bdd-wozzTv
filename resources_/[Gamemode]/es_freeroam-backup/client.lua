...
AddEventHandler("playerSpawned", function(spawn)
  ...
  Citizen.CreateThread(function()
      ...
      AddTextComponentString("Bienvenue sur Avanya !");
      SetNotificationMessage("CHAR_ALL_PLAYERS_CONF", "CHAR_ALL_PLAYERS_CONF", true, 1, "Discord: ", "https://discord.gg/Nu562yK");
...
RegisterNetEvent('es_freeroam:teleport')
AddEventHandler('es_freeroam:teleport', function(pos)
	pos.x = pos.x + 0.0
	pos.y = pos.y + 0.0
	pos.z = pos.z + 0.0
