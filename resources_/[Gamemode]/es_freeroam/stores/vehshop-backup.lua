	...
	menu = {
		...
		["compacts"] = {
			...
			buttons = {
				...
				{name = "Beetle '74", costs = 45960, description = {}, model = "beetle74", vMax="65.36", accel="57.5", frein= "40"},
			}
		},
		["coupes"] = {
			title = "coupes",
		...
		["sportsclassics"] = {
			...
			buttons = {
				...
				{name = "Tornado3", costs = 37000, description = {}, model = "tornado3", vMax="75.12", accel="67.5", frein= "26.67"},
				{name = "Tornado4", costs = 35000, description = {}, model = "tornado4", vMax="75.12", accel="67.5", frein= "26.67"},
				{name = "Tornado Custom", costs = 65000, description = {}, model = "tornado5", vMax="75.12", accel="67.5", frein= "26.67"},
				{name = "Tornado Rat Rod", costs = 155000, description = {}, model = "tornado6", vMax="75.12", accel="67.5", frein= "26.67"},
			...
			while #vehshop_blips > 0 do
				...
				for i,b in ipairs(vehshop_blips) do
					...
					if vehshop.opened == false and IsPedInAnyVehicle(LocalPed(), true) == false and  GetDistanceBetweenCoords(b.pos.entering[1],b.pos.entering[2],b.pos.entering[3],GetEntityCoords(LocalPed())) < 5 then		
						drawTxt('Appuyer sur ~g~E~s~ pour accéder au menu d\'achat',0,1,0.5,0.8,0.6,255,255,255,255)
						currentlocation = b
						inrange = true
					end
				end
