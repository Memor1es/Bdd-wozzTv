...
itemMenuGeneral = {
    ...
    ['Items'] = {
        ...
        { ['Title'] = 'Sortir une chaise',					['Event'] = 'wheelchair:addchair'},
        { ['Title'] = 'Ranger une chaise',					['Event'] = 'wheelchair:removeChair'},
        { ['Title'] = 'Enfiler le recycleur',				['Event'] = 'cookweapons:ToggleRecycleur', ['Close'] = false},
        { ['Title'] = 'Demenotter',							['Event'] = 'cookganghandcuff:tryHandcuff', ['Close'] = false},
        { ['Title'] = 'Retirer un sac (sur la tete)',		['Event'] = 'es_worek:start', ['Close'] = false},
        { ['Title'] = 'Mettre / retirer le stéthoscope',	['Event'] = 'menueems:ste', ['Close'] = false},
		{ ['Title'] = 'Ranger votre Vehicule',				['Event'] = 'wk:deleteVehicleAmbu'},
		{ ['Title'] = 'Quitter le service',					['Event'] = 'ambulancier:leaveService'},
    }
}
...
itemMenuChoixCar = {
    ...
    ['Items'] = {
		...
		{['Title'] = 'Intervention', ['Function'] = invokeVehicle, type = 3},
...
function AMBULANCE_deleteVehicle()
