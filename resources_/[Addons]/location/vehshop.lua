...
local voitureshop = {
	...
	menu = {
		...
		["Voiture-Sans-Permis"] = { 
			...
			buttons = { 
				{name = "Punto", costs = 150, description = {}, model = "panto"},
				{name = "Faggio", costs = 125, description = {}, model = "faggio2"},
...
{
	{entering = {-1037.703, -2737.613, 20.169}, inside = {-1037.703, -2737.613, 20.169, 330.105}, outside = {-1037.703, -2737.613, 20.169, 330.105}},
	{entering = {-904.39,-2337.38,6.71}, inside = {-905.96,-2333.15,6.71,62.16}, outside = {-905.96,-2333.15,6.71,62.16}},
	{entering = {234.3679, -751.95, 34.6316}, inside = {234.3679, -751.95, 34.6316, 73.246}, outside = {234.3679, -751.95, 34.6316, 73.246}},
}
		...
		Citizen.CreateThread(function()
			while #voitureshop_blips > 0 do
				...
				for i,b in ipairs(voitureshop_blips) do
					if voitureshop.opened == false and IsPedInAnyVehicle(LocalPed(), true) == false and  GetDistanceBetweenCoords(b.pos.entering[1],b.pos.entering[2],b.pos.entering[3],GetEntityCoords(LocalPed())) < 20.0 then
						DrawMarker(25,b.pos.entering[1], b.pos.entering[2], b.pos.entering[3] - 0.95, 0, 0, 0, 0, 0, 0, 2.0, 2.0, 2.0, 72, 164, 255, 50, 0, 0, 2, 0, 0, 0, 0)
					end
					if voitureshop.opened == false and IsPedInAnyVehicle(LocalPed(), true) == false and  GetDistanceBetweenCoords(b.pos.entering[1],b.pos.entering[2],b.pos.entering[3],GetEntityCoords(LocalPed())) < 2.0 then
						DisplayHelpText("Appuyez sur ~INPUT_CONTEXT~ pour acceder aux ~b~véhicules")
...
function CloseCreatorvoiture()
	Citizen.CreateThread(function()
		...
		if not boughtvoiture then
			...
			DecorSetBool(personalvehicle, "RainbowLand", true)
			...
			SetVehicleNumberPlateText(personalvehicle, "RBL")
			SetEntityVisible(ped,true)
		end
...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(0)
		if IsControlJustPressed(1, 51) and IsPlayerinrangeofvoitureshop() then
					...
					if voitureshop.currentmenu == "Voiture-Sans-Permis" or voitureshop.currentmenu == "Voiture-Avec-Permis" then
						if selected then
							if fakevoiture.model ~= button.model then
								...
								DecorRegister("RainbowLand", 2)
								DecorSetBool(veh, "RainbowLand", true)
								...
								SetVehicleNumberPlateText(veh, "RBL")
