...
local clothingStores = {
    ...
    --{ x = 1693.2647705078,      y = 4822.2797851563,    z = 42.063091278076,    markerWidth = 7.0001,  activationDist = 2.5 },
   -- { x = 125.83338165283,      y = -223.16986083984,   z = 54.55782699585,     markerWidth = 7.0001,  activationDist = 2.5 },
    --{ x = -710.16009521484,     y = -153.26420593262,   z = 37.415138244629,    markerWidth = 7.0001,  activationDist = 2.5 },
    --{ x = -821.69067382813,     y = -1073.900390625,    z = 11.328099250793,    markerWidth = 7.0001,  activationDist = 2.5 },
    --{ x = -1192.8112792969,     y = -768.24377441406,   z = 17.319314956665,    markerWidth = 7.0001,  activationDist = 2.5 },
    --{ x = 4.2589497566223,      y = 6512.8803710938,    z = 31.877851486206,    markerWidth = 7.0001,  activationDist = 2.5 },
    --{ x = -1097.98095703125,    y = 2708.9150390625,    z = 19.107873916626,    markerWidth = 7.0001,  activationDist = 2.5 },
    --{ x = -3170.45434570313,    y = 1045.53295898438,   z = 20.8632144927979,   markerWidth = 7.0001,  activationDist = 2.5 },
    --{ x = -162.942764282227,    y = -302.322326660156,  z = 39.733283996582,    markerWidth = 7.0001,  activationDist = 2.5 },
   -- { x = -1452.13696289063,    y = -236.172698974609,  z = 49.806259155,       markerWidth = 7.0001,  activationDist = 2.5 }
}
...
Citizen.CreateThread(function()
    setMapMarker(clothingStores, 73, 4, "Magasins de vêtements")
    while true do
        Citizen.Wait(0)
        if isNearShop() then
