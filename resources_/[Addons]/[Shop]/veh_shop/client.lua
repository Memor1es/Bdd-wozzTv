...
local boats = {
    ...
    { name= 'seashark', model= -1030275036, price = 80000 },
...
local copter = {
    { name= 'Buzzard2' ,model= 745926877, price = 450000 },
    { name= 'Frogger' ,model= 744705981, price = 230000 },
    { name= 'Maverick' ,model= -1660661558, price = 215000 },
    { name= 'Supervolito2' ,model= -1671539132, price = 280000 },
    { name= 'Swift' ,model= -339587598, price = 255000 },
    { name= 'Swift2' ,model= 1075432268, price = 325000 },
    { name= 'Volatus' ,model= -1845487887, price = 420000 }
}

local planes = {
    { name= 'Besra' ,model=1824333165, price = 477500 },
    { name= 'Cuban800' ,model=-644710429, price = 185000 },
    { name= 'Dodo' ,model=-901163259, price = 210000 },
    { name= 'Duster' ,model=970356638, price = 168000 },
    { name= 'Luxor' ,model=621481054, price = 1236500 },
    { name= 'Luxor2' ,model=-1214293858, price = 2165000 },
    { name= 'Mammatus' ,model=-1746576111, price = 192500 },
    { name= 'Nimbus' ,model=-1295027632, price = 965500 },
    { name= 'Shamal' ,model=-1214505995, price = 873600 },
    { name= 'Stunt' ,model=-2122757008, price = 985000 },
    { name= 'Velum' ,model=-1673356438, price = 138500 },
    { name= 'Vestra' ,model=1341619767, price = 156500 },
}
...
local sellers = {
    ...
    --{ name= 'Revente de véhicule',  x = -1167.28, y= -2013.38, z=  12.23, direction =  308.11, activationDist=2.5, markerWidth = 1.05001, markerType= 434, markerColor= 6, spawnable=1 },
