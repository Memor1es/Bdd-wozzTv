...
Menu.item = {
    ['Title'] = 'Magasin',
    ['Items'] = {
        {['Title'] = 'Sandwich 10$', ['Event'] = 'food:selection',['itemid']=30,['price']=10,['Close']= false},
        {['Title'] = 'Eau 7$', ['Event'] = 'food:selection',['itemid']=6,['price']=7,['Close']= false},
        {['Title'] = 'Kit de réparation 500$', ['Event'] = 'food:selection',['itemid']=47,['price']=500,['Close']= false}
    }
}
--====================================================================================
--  Option Menu
