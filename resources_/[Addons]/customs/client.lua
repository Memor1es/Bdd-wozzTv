...
local locations = { 
	{ name= "Benny's Original Motor Works", x = 937.4587, y= -970.9591, z= 29.89040184021, activationDist=12.5, markerWidth = 25.05001, markerType= 72, markerColor= 5 },
...
AddEventHandler('customs:checkifowner_fromdb', function(check)
    ...
    if not check then
        ...
        TriggerEvent("es_freeroam:notify", "CHAR_LS_CUSTOMS", 1, "LS Customs", false, "Tu me prends pour un ~r~nigo ~w~va t'acheter une caisse ~r~ pauvre type ou va voir le mecano!")
...
RegisterNUICallback('getbodymodlist', function(data, cb)
    ...
    if DoesEntityExist(currentVhl.vehicleId) then
		...
		GetModTextLabel(currentVhl.vehicleId, 0)
        ...
        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 11))), mod = 11, list = getModObject( currentVhl.vehicleId, 11)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 12))), mod = 12, list = getModObject( currentVhl.vehicleId, 12)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 13))), mod = 13, list = getModObject( currentVhl.vehicleId, 13)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 14))), mod = 14, list = getModObject( currentVhl.vehicleId, 14)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 15))), mod = 15, list = getModObject( currentVhl.vehicleId, 15)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 16))), mod = 16, list = getModObject( currentVhl.vehicleId, 16)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 17))), mod = 17, list = getModObject( currentVhl.vehicleId, 17)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 18))), mod = 18, list = getModObject( currentVhl.vehicleId, 18)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 19))), mod = 19, list = getModObject( currentVhl.vehicleId, 19)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 20))), mod = 20, list = getModObject( currentVhl.vehicleId, 20)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 21))), mod = 21, list = getModObject( currentVhl.vehicleId, 21)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 22))), mod = 22, list = getModObject( currentVhl.vehicleId, 22)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 23))), mod = 23, list = getModObject( currentVhl.vehicleId, 23)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 24))), mod = 24, list = getModObject( currentVhl.vehicleId, 24)})
        ...
        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 40))), mod = 40, list = getModObject( currentVhl.vehicleId, 40)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 41))), mod = 41, list = getModObject( currentVhl.vehicleId, 41)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 42))), mod = 42, list = getModObject( currentVhl.vehicleId, 42)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 43))), mod = 43, list = getModObject( currentVhl.vehicleId, 43)})
        ...
        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 46))), mod = 46, list = getModObject( currentVhl.vehicleId, 46)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 47))), mod = 47, list = getModObject( currentVhl.vehicleId, 47)})
        ...
        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 49))), mod = 49, list = getModObject( currentVhl.vehicleId, 49)})

        table.insert(mods, {name = tostring(GetLabelText(GetModTextLabel(currentVhl.vehicleId, 50))), mod = 50, list = getModObject( currentVhl.vehicleId, 50)})
