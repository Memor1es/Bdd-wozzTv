function closures_mecano_server()
    ...
    function addMission(source, position)
    ...
    RegisterServerEvent("SyncMecano")
    AddEventHandler('SyncMecano', function(inputText)
        TriggerClientEvent('DisplayMecano', -1, inputText)
    end)
