...
AddEventHandler("gc:playAmination", function(dictionaries, clip, duration)
    ...
    if DoesEntityExist(lPed) then
        Citizen.CreateThread(function()
            ...
            --else
			--	TaskPlayAnim(lPed, dictionaries, clip, 1.0, -1.0, duration, 1, 1, true, true, true)
            --end

			if IsEntityPlayingAnim(lPed, dictionaries, clip, 3) then
                ClearPedSecondaryTask(lPed)
            else
				TaskPlayAnim(lPed, dictionaries, clip, 1.0, -1.0, duration, 8, 0, 0, 0, 0)
