...
Cfg.strings = {
    ...
    menuTitle       = "",
    menuSubtitle    = "Contrôle la caméra cinématique",

    toggleCam       = "Camera active",
    toggleCamDesc   = "Activer la caméra on/off",

    precision       = "Camera Precision",
    precisionDesc   = "Changer la précision de la caméra",

    filter          = "Filtre",
    filterDesc      = "Changer le filtre de la caméra",

    filterInten     = "Intensité du filtre",
    filterIntenDesc = "Changer l'intensité du filtre de la caméra",
    
    delFilter       = "Reset filtre",
    delFilterDesc   = "Retire le filtre et reset les valeures",

    showMap         = "Afficher la minimap",
    showMapDesc     = "Activer la minimap on/off",

    freeFly         = "Activer Free Fly Mode",
    freeFlyDesc     = "Switch entre le Free Fly ou revenir au Drone Mode",

    attachCam       = "Attacher la caméra à : ",
    attachCamDesc   = "Attacher la caméra à une entité",

    pointEntity     = "Pointer la caméra vers l'entité",
    pointEntityDesc = "Activer le pointage de la caméra vers l'entité",

    ctrlHelpRoll    = "Roll Gauche/Droite",
    ctrlHelpMove    = "Mouvement",
    ctrlHelpRotate  = "Rotation"
}
