...
if not HaveBagOnHead then
        ...
        local Worek = CreateObject(GetHashKey("prop_money_bag_01"), 0, 0, 0, true, true, true)

		DecorRegister("Avanya", 2)

		DecorSetBool(Worek, "Avanya", true)
