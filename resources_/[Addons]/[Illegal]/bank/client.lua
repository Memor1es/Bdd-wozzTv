...
local banks = {
    ...
    ["blainecounty"] = {
        position = { ['x'] = -107.065, ['y'] = 6474.801, ['z'] = 31.70 },
        reward = 25000,
...
AddEventHandler('es_bank:toofarlocal', function(robb)
    robbing = false
    TriggerEvent('chatMessage', 'SYSTEM', {255, 0, 0}, "Tu t'es trop éloigné, braquage annulé !")
    robbingName = ""
    secondsRemaining = 0
    incircle = false
end)
...
AddEventHandler('es_bank:robberycomplete', function(robb)
    robbing = false
    TriggerEvent("es_freeroam:notify", "CHAR_LESTER_DEATHWISH", 1, "Braquage", false, "~g~Braquage réussi !~w~ Votre butin est de ~g~$" .. banks[bank].reward .. "~w~.")
    bank = ""
    secondsRemaining = 0
    incircle = false
end)
