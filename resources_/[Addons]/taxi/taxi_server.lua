function closures_taxi_server()
    ...
    function addMission(source, position, type)
        ...
        if sMission == nil then
          if getNbPerosnnelDispo() == 0 and type == "1 personne" then
            TriggerClientEvent('taxi:callAutoTaxi', source, position, type)
    ...
    function personelAcceptMission(source, missionId)
        ...
        elseif #sMission.acceptBy ~= 0  and not acceptMulti then
            ...
            TriggerClientEvent('taxi:MissionAccept', source, sMission)
    ...
    RegisterServerEvent('taxi:PayAutomaticTaxi')
    AddEventHandler('taxi:PayAutomaticTaxi', function (price)
    ...
    RegisterServerEvent('taxi:endService')
    ...
    RegisterServerEvent('taxi:requestPersonnel')
    AddEventHandler('taxi:requestPersonnel', function ()
