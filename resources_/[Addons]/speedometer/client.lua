	...
	while true do
		...
		if(IsPedInAnyVehicle(Ped)) then
			...
			if PedCar and GetPedInVehicleSeat(PedCar, -1) == Ped then
				...
				if rpm > 0.9 then
					rpmfuel = fuel - rpm / 100000
					Citizen.Wait(1000)
				elseif rpm > 0.8 then
					rpmfuel = fuel - rpm / 1000000
					Citizen.Wait(1500)
				elseif rpm > 0.7 then
					rpmfuel = fuel - rpm / 200000
					Citizen.Wait(2000)
				elseif rpm > 0.6 then
					rpmfuel = fuel - rpm / 400000
					Citizen.Wait(3000)
				elseif rpm > 0.5 then
					rpmfuel = fuel - rpm / 500000
					Citizen.Wait(4000)
				elseif rpm > 0.4 then
					rpmfuel = fuel - rpm / 600000
					Citizen.Wait(5000)
				elseif rpm > 0.3 then
					rpmfuel = fuel - rpm / 600000
					Citizen.Wait(6000)
				elseif rpm > 0.2 then
					rpmfuel = fuel - rpm / 70000
					Citizen.Wait(8000)
				else
					rpmfuel = fuel - rpm / 700000
					Citizen.Wait(15000)
				end
